...
Computing the projections $P(x_i) \in \mathbb{R}^m$ for all $n$ data points requires $n \times m$ inner products, each of cost $O(d)$, resulting in a total preprocessing cost of:
\begin{equation}
