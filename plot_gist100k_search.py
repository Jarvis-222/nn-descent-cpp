#!/usr/bin/env python3
"""Plot GIST 100K search impact across projection-filter settings."""
...
CSV_PATH = "results/gist100k_search_sweep.csv"
OUT_PNG = "plots/gist100k_search_vs_ef.png"
OUT_PDF = "plots/gist100k_search_vs_ef.pdf"
...
def main():
    ...
    axes[0].set_title("GIST 100K: Search Recall vs ef", fontsize=13, fontweight="bold")
    axes[0].set_xlabel("ef")
    axes[0].set_ylabel("Search Recall@10")
    axes[0].grid(True, alpha=0.3)

    axes[1].set_title("GIST 100K: QPS vs ef", fontsize=13, fontweight="bold")
    ...
    plt.suptitle(
        ...
        "Random init, 1K held-out GIST queries, shared search algorithm",
        fontsize=14,
        fontweight="bold",
        y=1.03,
    )
